...
public class MainActivity extends AppCompatActivity {
    ...
    private static String ip = "192.168.43.5";//IP do Computador na tentativa de conexão estabelecida
    private static int porta = 8102;//Porta do Computador na tentativa de conexão estabelecida
    String message = "";
    String time = "";
    String recurrency = "";
    String flag = "";
    ...
    public class connectTask extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                //Enviando para o servidor as opções selecionadas
